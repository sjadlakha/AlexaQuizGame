...
def middleware(question_amount, category, diff):
    # pdb.set_trace()

    url = "https://opentdb.com/api.php?amount={ques}&category={category}&difficulty={diff}&type=multiple".format(
        ques=question_amount, category=category, diff=diff)
